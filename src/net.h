...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemadividendGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemadividendGrant grantOutbound;
