...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 DVD at the same time
...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzDVDTracker> zphrTracker;
    ...
    {
        zwalletMain = zwallet;
        zphrTracker = std::unique_ptr<CzDVDTracker>(new CzDVDTracker(strWalletFile));
    }
