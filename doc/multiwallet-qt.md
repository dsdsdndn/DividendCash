...
In order to support loading of multiple wallets in dividend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dividend.cpp.
...
Changes to dividend.cpp
----------------------
dividend.cpp is the entry point into dividend-qt, and as such, will require some minor modifications to provide hooks for
