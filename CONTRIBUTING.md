Contributing to Dividend Core
============================

The Dividend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dividend Core project, and is not to be
confused with overall Dividend Network Protocol consensus changes.

Whether a pull request is merged into Dividend Core rests with the project merge
...
Patches that change Dividend consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dividend consensus, it must have been
...
The project leader is the release manager for each Dividend Core release.
